...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultRaw = function defaultRaw(p) {
	  return p;
	};

	var createLocation = exports.createLocation = function createLocation(path, state, key, currentLocation) {
	  var raw = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : defaultRaw;
...
/***/ function(module, exports) {
	...
	var createPath = exports.createPath = function createPath(location) {
	  var rawPathname = location.rawPathname,
	      pathname = location.pathname,
	      search = location.search,
	      hash = location.hash;


	  var path = rawPathname || pathname || '/';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createBrowserHistory = function createBrowserHistory() {
	  ...
	  var getDOMLocation = function getDOMLocation(historyState) {
	    ...
	    return (0, _LocationUtils.createLocation)(path, state, key, undefined, _DOMUtils.browserEncode);
	  };
	  ...
	  var push = function push(path, state) {
	    ...
	    var action = 'PUSH';
	    var location = (0, _LocationUtils.createLocation)(path, state, createKey(), history.location, _DOMUtils.browserEncode);
...
/***/ function(module, exports) {
	...
	var browserEncode = exports.browserEncode = function browserEncode(pathname) {
	  var a = document.createElement('a');
	  a.href = pathname;
	  var encodedPathname = a.pathname;
	  // IE10 and IE11 do not prepend the pathname with a `/` contrary
	  // to other browsers.
	  return encodedPathname.charAt(0) === '/' ? encodedPathname : '/' + encodedPathname;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createHashHistory = function createHashHistory() {
	  ...
	  var getDOMLocation = function getDOMLocation() {
	    ...
	    return (0, _LocationUtils.createLocation)(path, undefined, undefined, undefined, _DOMUtils.browserEncode);
	  };
	  ...
	  var push = function push(path, state) {
	    ...
	    var action = 'PUSH';
	    var location = (0, _LocationUtils.createLocation)(path, undefined, undefined, history.location, _DOMUtils.browserEncode);
